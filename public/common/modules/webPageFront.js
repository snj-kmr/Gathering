//var webpagesModule = angular.module('ghangout.webPage', ['ngSanitize']);
var webpagesModule = angular.module('ghangout.webPageFront', ['pascalprecht.translate', 'ngSanitize']);
...
webpagesModule.service('webPageFront', function ($http) {
